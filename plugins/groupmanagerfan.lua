...
local function modlist(msg)
  ...
  if next(data[tostring(msg.chat_id_)]['mods']) == nil then --fix way
    return "در این گروه هیچ کسی معاون ربات نیست👤🤖"
  end
...
local function ownerlist(msg)
  ...
  if next(data[tostring(msg.chat_id_)]['owners']) == nil then --fix way
    return "هیچ مدیری در این گروه نیست👤❗️"
  end
...
local text = "⚙تنظیمات قفلی گروه⛓:\n🔐 #قفل پین: *"..settings.lock_edit.."*\n🔐 #قفل لینک: *"..settings.lock_link.."*\n🔐 #قفل هشتگ: *"..settings.lock_tag.."*\n🔐 #قفل فلود: *"..settings.flood.."*\n🔐 #قفل اسپم: *"..settings.lock_spam.."*\n🔐 #قفل یوزرنیم: *"..settings.lock_mention.."*\n🔐 #قفل صفحات وب: *"..settings.lock_webpage.."*\n🔐 #قفل مارک داون: *"..settings.lock_markdown.."*\n🔐 #قفل ربات های مخرب: *"..settings.lock_bots.."*\n 🔐 #میزان حساسیت فلود: *"..NUM_MSG_MAX.."*\n➖➖➖➖➖➖➖➖➖➖➖\n ⛓تنظیمات موت گروه⚙ : \n🔐 #موت همه : *"..settings.mute_all.."*\n🔐 #موت گیف : *"..settings.mute_gif.."*\n🔐 #موت متن : *"..settings.mute_text.."*\n🔐 #موت لینک شیشه ای : *"..settings.mute_inline.."*\n🔐 #موت بازی : *"..settings.mute_game.."*\n🔐 #موت عکس : *"..settings.mute_photo.."*\n🔐 #موت ویدیو : *"..settings.mute_video.."*\n🔐 #موت اهنگ : *"..settings.mute_audio.."*\n🔐 #موت وویس : *"..settings.mute_voice.."*\n🔐 #موت استیکر: *"..mutes.mute_sticker.."*\n🔐 #موت مخاطب : *"..settings.mute_contact.."*\n🔐 #موت فوروارد : *"..settings.mute_forward.."*\n🔐 #موت ارسال مکان : *"..settings.mute_location.."*\n🔐 #موت ارسال فایل : *"..settings.mute_document.."*\n🔐 #موت ورود و خروج : *"..settings.mute_tgservice.."*\n\n🔶موت به معنی سکوت کردن است و زمان فعال بودن فایل داری ان محتوا را پاک میکنید و مقابل ان انموت است🔷*\n\n👤💎سودو و برنامه نویس* : @sudoradmhr021\n👥کانال ما : @DJteamm"
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
    tdcli_function ({
      ...
      chat_id_ = msg.chat_id_,
      message_id_ = msg.reply_to_message_id_
    }, action_by_reply, {chat_id=msg.chat_id_,cmd="مدیر"})
  end
  if matches[2] and string.match(matches[2], '^%d+$') then
tdcli_function ({
    ID = "GetUser",
    user_id_ = matches[2],
  }, action_by_id, {chat_id=msg.chat_id_,user_id=matches[2],cmd="مدیر"})
    end
  if matches[2] and not string.match(matches[2], '^%d+$') then
   tdcli_function ({
      ID = "SearchPublicChat",
      username_ = matches[2]
    }, action_by_username, {chat_id=msg.chat_id_,username=matches[2],cmd="مدیر"})
      end
   end
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
    tdcli_function ({
      ...
      chat_id_ = msg.chat_id_,
      message_id_ = msg.reply_to_message_id_
    }, action_by_reply, {chat_id=msg.chat_id_,cmd="تنزل مدیر"})
  end
  if matches[2] and string.match(matches[2], '^%d+$') then
tdcli_function ({
    ID = "GetUser",
    user_id_ = matches[2],
  }, action_by_id, {chat_id=msg.chat_id_,user_id=matches[2],cmd="تنزل مدیر"})
    end
  if matches[2] and not string.match(matches[2], '^%d+$') then
   tdcli_function ({
      ID = "SearchPublicChat",
      username_ = matches[2]
    }, action_by_username, {chat_id=msg.chat_id_,username=matches[2],cmd="تنزل مدیر"})
      end
   end
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
    tdcli_function ({
      ...
      chat_id_ = msg.chat_id_,
      message_id_ = msg.reply_to_message_id_
    }, action_by_reply, {chat_id=msg.chat_id_,cmd="معاون"})
  end
  if matches[2] and string.match(matches[2], '^%d+$') then
tdcli_function ({
    ID = "GetUser",
    user_id_ = matches[2],
  }, action_by_id, {chat_id=msg.chat_id_,user_id=matches[2],cmd="معاون"})
    end
  if matches[2] and not string.match(matches[2], '^%d+$') then
   tdcli_function ({
      ID = "SearchPublicChat",
      username_ = matches[2]
    }, action_by_username, {chat_id=msg.chat_id_,username=matches[2],cmd="معاون"})
      end
   end
...
if not matches[2] and tonumber(msg.reply_to_message_id_) ~= 0 then
    tdcli_function ({
      ...
      chat_id_ = msg.chat_id_,
      message_id_ = msg.reply_to_message_id_
    }, action_by_reply, {chat_id=msg.chat_id_,cmd="تنزل"})
  end
  if matches[2] and string.match(matches[2], '^%d+$') then
tdcli_function ({
    ID = "GetUser",
    user_id_ = matches[2],
  }, action_by_id, {chat_id=msg.chat_id_,user_id=matches[2],cmd="تنزل"})
    end
  if matches[2] and not string.match(matches[2], '^%d+$') then
    tdcli_function ({
      ID = "SearchPublicChat",
      username_ = matches[2]
    }, action_by_username, {chat_id=msg.chat_id_,username=matches[2],cmd="تنزل"})
      end
   end
...
➖➖➖➖➖➖➖➖➖➖➖
⬅️بازکردن  [ لینک ، هشتگ ، ادیت ، صفحات وب ، ربات ، اسپم ، فلود ، یوزرنیم ]
...
➖➖➖➖➖➖➖➖➖➖➖
⬅️تنظیمات
نمایش تنظیمات قفلی گروه به همراه موت لیست⚙
➖➖➖➖➖➖➖➖➖➖➖
⬅️لیست مدیران
...
➖➖➖➖➖➖➖➖➖➖➖
➡️!lock fosh
درصورت نوشتن پیام های🔞ربات ان ها را حدف میکند🚷
➡️!unlock fosh
بازکردن قفل کلمات🔞
➖➖➖➖➖➖➖➖➖➖➖
...
⬅️نوشتن [کلمه]
طراحی کلمه با 100فونت مختلف💱
🔸توجه کلمه باید به لاتین نوشته شود 
مثال : نوشتن titan

⬅️ساعت
دریافت ساعت و تاریخ به صورت استیکر و نوشته⏰📆
